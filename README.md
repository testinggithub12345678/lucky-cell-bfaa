...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-cell-bfaa
```

## Preview Deployment

A live public deployment of this template is available at [https://lucky-cell-bfaa.templates.workers.dev](https://lucky-cell-bfaa.templates.workers.dev)
